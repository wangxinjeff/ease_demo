            ...
            case MSG_CALL_MAKE_VOICE:
                try {
                    ...
                    if (msg.what == MSG_CALL_MAKE_VIDEO) {
                        ...
                        EMClient.getInstance().callManager().makeVoiceCall(username, "{'CHatUserId':'doc_72','CHatUserNick':'高赛'," +
                                "'ChatUserPic':'http://pic_01.ytapp.cn/imgBox.aspx?photoPath\u003d/UF/apply/201908/08/" +
                                "1856581200.png\u0026width\u003d300\u0026height\u0003d300'}", record, merge);
                    }
...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        if(callType == 0) {
            ...
            message.setAttribute("newState", "1");
        }else {
            message.setAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, true);
            message.setAttribute("newState", "2");
        }
        // set message body
