...
import static com.hyphenate.easeui.utils.EaseImageUtils.getThumbnailImagePath;
...
public class EaseChatRowImage extends EaseChatRowFile{
    ...
    protected void onSetUpView() {
        ...
        String thlocal = imgBody.thumbnailLocalPath();
        String filePath = imgBody.getLocalUrl();
        String thumbPath = getThumbnailImagePath(imgBody.getLocalUrl());
            ...
            if(EMClient.getInstance().getOptions().getAutodownloadThumbnail()){
                ...
                if (imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                    ...
                    if (!new File(thumbPath).exists()) {
                        ...
                        thumbPath = getThumbnailImagePath(imgBody.getLocalUrl());
                    }
